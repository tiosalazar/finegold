...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Planmyday
	 * @var $inverse	- added by Planmyday
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Planmyday:
	// Color scheme
	if ($scheme && !planmyday_param_is_off($scheme) && !planmyday_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !planmyday_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Planmyday color scheme in the row
	if ($scheme && !planmyday_param_is_off($scheme) && !planmyday_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php planmyday_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php planmyday_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
