			...
			<div class="comments_form">
				...
				$comments_args = array(
						...
						'comment_field' => '<div class="comments_field comments_message">'
											. '<textarea id="comment" name="comment"' . ($form_style == 'default' ? ' placeholder="' . esc_attr__( 'Comment', 'planmyday' ) . '"' : '') . ' aria-required="true"></textarea>'
											. ($form_style != 'default'
												? '<label for="comment" class="required">'
														...
														. '<span class="sc_form_label_content" data-content="' . esc_html__('Your Message', 'planmyday') . '">'
															. esc_html__('Your Message', 'planmyday')
														. '</span>'
													. '</label>'
												: ''
												)
						...
						'fields' => apply_filters( 'comment_form_default_fields', array(
							'author' => '<div class="comments_field comments_author">'
										. '<input id="author" name="author" type="text"' . ($form_style == 'default' ? '  placeholder="' . esc_attr__( 'Name', 'planmyday' ) . ( $req ? ' *' : '') . '"' : '') . ' value="' . esc_attr( isset($commenter['comment_author']) ? $commenter['comment_author'] : '' ) . '" size="30"' . ($aria_req) . ' />'
										. ($form_style != 'default'
											? '<label for="author"' . ( $req ? ' class="required"' : '' ). '>'
													...
													. '<span class="sc_form_label_content" data-content="' . esc_html__('Name', 'planmyday') . '">'
														. esc_html__('Name', 'planmyday')
													. '</span>'
												. '</label>'
											: ''
											)
							...
							'email' => '<div class="comments_field comments_email">'
										. '<input id="email" name="email" type="text"' . ($form_style == 'default' ? '  placeholder="' . esc_attr__( 'Email', 'planmyday' ) . ( $req ? ' *' : '') . '"' : '') . ' value="' . esc_attr(  isset($commenter['comment_author_email']) ? $commenter['comment_author_email'] : '' ) . '" size="30"' . ($aria_req) . ' />'
										. ($form_style != 'default'
											? '<label for="email"' . ( $req ? ' class="required"' : '' ) . '>'
													...
													. '<span class="sc_form_label_content" data-content="' . esc_html__('E-mail', 'planmyday') . '">'
														. esc_html__('E-mail', 'planmyday')
													. '</span>'
												. '</label>'
											: ''
											)
							...
							'url' => '<div class="comments_field comments_site">'
										. '<input id="url" name="url" type="text"' . ($form_style == 'default' ? '  placeholder="' . esc_attr__( 'Website', 'planmyday' ) . '"' : '') . ' value="' . esc_attr(  isset($commenter['comment_author_url']) ? $commenter['comment_author_url'] : '' ) . '" size="30"' . ($aria_req) . ' />'
										. ($form_style != 'default'
											? '<label for="url" class="optional">'
													...
													. '<span class="sc_form_label_content" data-content="' . esc_html__('Website', 'planmyday') . '">'
														. esc_html__('Website', 'planmyday')
													. '</span>'
												. '</label>'
										    : ''
										    )
