...
if ( !function_exists( 'planmyday_template_form_2_theme_setup' ) ) {
	add_action( 'planmyday_action_before_init_theme', 'planmyday_template_form_2_theme_setup', 1 );
	function planmyday_template_form_2_theme_setup() {
		planmyday_add_template(array(
			'layout' => 'form_2',
			'mode'   => 'forms',
			'title'  => esc_html__('Contact Form 2', 'planmyday')
			));
	}
}

// Template output
if ( !function_exists( 'planmyday_template_form_2_output' ) ) {
	function planmyday_template_form_2_output($post_options, $post_data) {
