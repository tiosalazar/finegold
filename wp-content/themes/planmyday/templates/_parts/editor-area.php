...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style ( 'fontello-admin',        planmyday_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null);
	wp_enqueue_style ( 'frontend-editor-style', planmyday_get_file_url('js/core.editor/core.editor.css'), array(), null );
	wp_enqueue_script( 'frontend-editor',       planmyday_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
	planmyday_enqueue_messages();
	planmyday_options_load_scripts();
	planmyday_options_prepare_scripts($post_data['post_type']);
	...
	<div id="frontend_editor">
		<div id="frontend_editor_inner">
			<form method="post">
				<label id="frontend_editor_post_title_label" for="frontend_editor_post_title"><?php esc_html_e('Title', 'planmyday'); ?></label>
				...
				?>
				<label id="frontend_editor_post_excerpt_label" for="frontend_editor_post_excerpt"><?php esc_html_e('Excerpt', 'planmyday'); ?></label>
				...
				<input type="button" id="frontend_editor_button_save" value="<?php esc_attr_e('Save', 'planmyday'); ?>" />
				<input type="button" id="frontend_editor_button_cancel" value="<?php esc_attr_e('Cancel', 'planmyday'); ?>" />
