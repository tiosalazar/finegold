...
function planmyday_ready_actions() {
    ...
    //----------------------------------------------
	if (window.planmyday_theme_ready_actions) planmyday_theme_ready_actions();
	...
	PLANMYDAY_STORAGE['top_panel_height'] = 0;	//Math.max(0, jQuery('.top_panel_wrap').height());
...
function planmyday_scroll_actions() {
	...
	// Call theme specific action (if exists)
    //----------------------------------------------
	if (window.planmyday_theme_scroll_actions) planmyday_theme_scroll_actions();
...
function planmyday_resize_actions() {
	...
	// Call theme specific action (if exists)
    //----------------------------------------------
	if (window.planmyday_theme_resize_actions) planmyday_theme_resize_actions();
...
function planmyday_show_popup(popup) {
    "use strict";
	if (popup.css('display')=='none') {
		if (false && PLANMYDAY_STORAGE['css_animation'])
