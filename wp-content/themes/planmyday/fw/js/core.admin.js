/**
 * Planmyday Framework: Admin scripts
 *
 * @package	planmyday
 * @since	planmyday 1.0
 */
...
jQuery(document).ready(function() {
	...
	jQuery('.widgets_param_post_type_selector').on('change', function() {
		...
		planmyday_admin_fill_categories(this, cat_fld, cat_lbl);
		return false;
	});
	// Set parent course
	jQuery('.planmyday_course_selector').on('click', function(e) {
		"use strict";
...
function planmyday_admin_fill_categories(fld, cat_fld, cat_lbl) {
	"use strict";
	var cat_value = planmyday_get_listbox_selected_value(cat_fld.get(0));
